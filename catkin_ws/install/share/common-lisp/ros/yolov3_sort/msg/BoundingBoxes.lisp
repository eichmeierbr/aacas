...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector yolov3_sort-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'yolov3_sort-msg:BoundingBox :initial-element (cl:make-instance 'yolov3_sort-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolov3_sort-msg:<BoundingBoxes> is deprecated: use yolov3_sort-msg:BoundingBoxes instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:header-val is deprecated.  Use yolov3_sort-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_header-val :lambda-list '(m))
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:image_header-val is deprecated.  Use yolov3_sort-msg:image_header instead.")
  (image_header m))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:bounding_boxes-val is deprecated.  Use yolov3_sort-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'yolov3_sort-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<BoundingBoxes>)))
  ...
  "e32fd70da813af4f3328d5a5c1025351")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'BoundingBoxes)))
  "Returns md5sum for a message object of type 'BoundingBoxes"
  "e32fd70da813af4f3328d5a5c1025351")
