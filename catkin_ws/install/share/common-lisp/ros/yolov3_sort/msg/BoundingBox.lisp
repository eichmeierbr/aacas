...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBox>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBox)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolov3_sort-msg:<BoundingBox> is deprecated: use yolov3_sort-msg:BoundingBox instead.")))

(cl:ensure-generic-function 'label-val :lambda-list '(m))
(cl:defmethod label-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:label-val is deprecated.  Use yolov3_sort-msg:label instead.")
  (label m))

(cl:ensure-generic-function 'idx-val :lambda-list '(m))
(cl:defmethod idx-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:idx-val is deprecated.  Use yolov3_sort-msg:idx instead.")
  (idx m))

(cl:ensure-generic-function 'xmin-val :lambda-list '(m))
(cl:defmethod xmin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:xmin-val is deprecated.  Use yolov3_sort-msg:xmin instead.")
  (xmin m))

(cl:ensure-generic-function 'ymin-val :lambda-list '(m))
(cl:defmethod ymin-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:ymin-val is deprecated.  Use yolov3_sort-msg:ymin instead.")
  (ymin m))

(cl:ensure-generic-function 'xmax-val :lambda-list '(m))
(cl:defmethod xmax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:xmax-val is deprecated.  Use yolov3_sort-msg:xmax instead.")
  (xmax m))

(cl:ensure-generic-function 'ymax-val :lambda-list '(m))
(cl:defmethod ymax-val ((m <BoundingBox>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov3_sort-msg:ymax-val is deprecated.  Use yolov3_sort-msg:ymax instead.")
  (ymax m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BoundingBox>)))
  ...
  (cl:format cl:nil "int64 label~%int64 idx~%float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BoundingBox)))
  "Returns full string definition for message of type 'BoundingBox"
  (cl:format cl:nil "int64 label~%int64 idx~%float64 xmin~%float64 ymin~%float64 xmax~%float64 ymax~%~%~%"))
